...
const ProductCard = ({ 
    ...
    const handleAdd = () => {
        ...
        console.log('AddItem result:', success, 'StoreId:', storeId)

        if (!success) {
            alert("Sizda boshqa restorandan mahsulotlar bor!")
            message.warning({
                content: "Savatchangizda boshqa restoranning mahsulotlari bor. Davom etish uchun avval ularni o'chirib tashlang.",
