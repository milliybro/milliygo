...
function ContractInvoiceControl() {
  const t = useTranslations('')

  const columns = [
    {
      title: t('contract.invoice-number'),
      dataIndex: 'typeDocument',
      key: 'typeDocument',
    },
    {
      title: t('contract.date-of-shipment'),
    ...
    {
      title: t('contract.date-follow'),
      dataIndex: 'updateDate',
      key: 'updateDate',
    },
    {
      title: t('contract.payment-status'),
      dataIndex: 'updateDate',
      key: 'updateDate',
    },
  ]
  ...
  return (
    <ContractLayout
      breadCrumbItems={[
        ...
        {
          title: t('contract.invoice-control'),
        },
      ]}
    >
...
export default ContractInvoiceControl
