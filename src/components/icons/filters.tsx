...
const defaultIcon = (): React.ReactElement => (
  <svg width="100%" height="1em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 18" fill="none">
    <path
      d="M1 4H4"
      stroke="currentColor"
      strokeWidth="1.5"
...
export default function FiltersIcon(props: Partial<CustomIconComponentProps>): ReactElement {
