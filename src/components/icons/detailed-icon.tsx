...
const defaultIcon = (): React.ReactElement => (
  <svg width="1em" height="1em" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g id="elements">
      <path
        id="Rectangle 2172"
...
export default function DetailedIcon(props: Partial<CustomIconComponentProps>): ReactElement {
