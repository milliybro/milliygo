...
const faceBook = () => {
  return (
    ...
    >
      <g id="Socials" clipPath="url(#clip0_3526_986)">
        <path
          id="Vector"
...
export default function FaceBookIcon(props: Partial<CustomIconComponentProps>): ReactElement {
  return <Icon component={faceBook} {...props} />
}
