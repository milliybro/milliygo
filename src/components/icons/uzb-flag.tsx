...
const defaultIcon = () => {
  return (
    <svg
      ...
      fill="none"
    >
      <g clipPath="url(#clip0_4161_53721)">
        <rect width="21" height="15" rx="3" fill="#F93939" />
        <path fillRule="evenodd" clipRule="evenodd" d="M0 11H21V15H0V11Z" fill="#00B731" />
        <path fillRule="evenodd" clipRule="evenodd" d="M0 0H21V4H0V0Z" fill="#03BCDB" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
...
export default function UzbFlagIcon(props: Partial<CustomIconComponentProps>): ReactElement {
