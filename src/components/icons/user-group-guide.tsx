...
const defaultIcon = () => {
  return (
    ...
    >
      ...
      />
      <path
        d="M17.7144 13C20.0813 13 22.0001 14.9188 22.0001 17.2857C22.0001 18.2325 21.2326 19 20.2858 19"
        stroke="currentColor"
        strokeWidth={1.5}
        strokeLinecap="round"
        strokeLinejoin="round"
...
export default function UserGroupGuideIcon(props: Partial<CustomIconComponentProps>): ReactElement {
