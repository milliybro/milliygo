...
import PropertiesDashboardMain from '@/features/Account/properties/PropertiesDashboardMain'
...
const PropertiesInfoPage = (props: { queryId: string; action: string }) => {
  const { queryId, action } = props
  if (!queryId) return null

  return (
    <CheckAuthLayout>
      <PropertiesDashboardMain queryId={queryId} queryAction={action} />
    </CheckAuthLayout>
  )
}
